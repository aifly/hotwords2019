...
/***/ (function(module, exports, __webpack_require__) {
	...
	// 				<div class='zmiti-player flash' v-if='showPlayer' >
	// 					<img @touchstart='playVideo'  @touchend='playVideo' :src="imgs.okBtn"  alt="">
	// 					<div>点击播放</div>
	// 				</div>
	//
	...
	// 					{{nickname||'新华社网友'}}
	// 				</div>
	// 				<div class='zmiti-change-btn flash'  v-if='showChangeBtn' @touchstart='touchstart' v-tap='[randomImg]' @touchend='touchend'>
	// 					<img :src="imgs.okBtn" alt="" @touchstart='imgStart' class='zmiti-prevent-img'>
	// 					<div>抽一张</div>
	// 				</div>
